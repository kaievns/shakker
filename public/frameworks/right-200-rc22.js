...
Wrappers_Cache = [], UID_KEY = 'uniqueNumber' in HTML ? 'uniqueNumber' : '_rid'+ new Date().getTime(), // !#server
...
var Wrapper = RightJS.Wrapper = function(parent, methods) {
  ...
  var Klass = function(object, options) {
    ...
    var instance = this, unit = instance._;
    ...
    return (Wrappers_Cache[$uid(unit)] = instance);
  };
...
Element.include({
   ...
   */
  clone: function() {
    return new Element(this._.clone(true));
